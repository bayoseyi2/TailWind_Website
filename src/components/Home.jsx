  ...
  return (
    <div name='home' className='w-full bg-[#bdc4bd99]'>
     ...
     <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center'>
        ...
        <p className='text-4xl py-4 max-w-[800px] text-[#8892b0]'>With several years of experience in data analysis, previous experience includes almost two decades in banking, sales, customer service and business intelligence. I am passionate about data analysis and visualization.
